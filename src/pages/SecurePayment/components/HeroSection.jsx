    ...
    return (
        <div className='flex flex-col md:flex-row md:mt-20 w-full'>
            <div className='flex flex-col lg:flex-row mt-10 md:mt-20 xl:mt-36 justify-between relative w-full gap-8'>
                ...
                <div className='flex mt-20 md:mt-0 justify-start md:w-1/2 overflow-hidden max-h-[400px] md:max-h-full overflow-hidden justify-end items-center'>

                    <img src={PaymentImage} alt="payment image" className='flex h-[300px]' />
                </div>
