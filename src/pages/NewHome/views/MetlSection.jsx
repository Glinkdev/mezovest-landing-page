        ...
        <div className='py-7 md:pt-36 pb-20 px-6 xl:px-36 h-full min-h-fit font-poppins !bg-[#fff]'>
            ...
            <div className='flex flex-col md:flex-row w-full'>
                ...
                <div className=' md:w-2/5 mt-10 md:mt-0 flex justify-end md:ml-20'>
                     <LazyLoadImage height={"100%"} width={"100%"} effect="blur"  src={MezoEnergyImage} alt="Mezo Energy Image" className='w-full h-full max-w-[1000px]' />
                </div>
            ...
            <div className='flex align-center justify-between mt-12 md:mt-28 max-w-[800px] m-auto'>
                {qualities.map((item, index) => (
                    <div className='flex flex-col' key={index}>
                         <LazyLoadImage height={"100%"} width={"100%"} effect="blur"  src={item.icon} className="h-12 fill-green" />
