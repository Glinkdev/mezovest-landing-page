            ...
            <div className='flex flex-col-reverse flex-col lg:flex-row w-full mt-20 gap-20'>
                ...
                <div className='md:w-1/2'>
                    ...
                    <div className='flex flex-col mt-6 md:mt-10'>
                        <h5 className='font-liquefier text-black text-5xl md:text-7xl md:text-[100px] font-normal leading-none text-green'>Cashflow</h5>
                        <h5 className='font-liquefier text-black text-5xl md:text-7xl md:text-[100px] font-normal leading-none '>Management</h5>
                    </div>
                    <p className='text-sm mt-8'>From customised close-of-day transfers and detailed activity and sales reports to robust business checking account features, our tools help you track, spend and move your money however you want.</p>
