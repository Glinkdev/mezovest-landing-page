        ...
        <div className='py-7 md:pt-14 pb-20 px-6 xl:px-36 !bg-white h-full min-h-fit font-poppins'>
            <div className='flex text-center mb-6 max-w-6xl m-auto border border-grey-200 py-9 md:py-14 md:px-12 rounded-3xl bg-[#203035] mt-20 overflow-hidden relative'>
                <div className='w-full md:w-3/5'>
                    <h1 className='font-liquefier text-[#E2FFF0] text-5xl md:text-7xl  font-normal leading-none'>Grow <span className='text-green'>Your</span></h1>
                    <h1 className='font-liquefier text-[#E2FFF0] text-5xl md:text-7xl  font-normal leading-none text-green'>Business</h1>
                    <h5 className='font-liquefier text-[#E2FFF0] text-5xl md:text-7xl  font-normal leading-none'> with ease</h5>
