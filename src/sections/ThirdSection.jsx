...
function ThirdSection() {
  return (
    <div className='py-14 md:pt-28 pb-20 px-6 xl:px-36 !bg-black h-full min-h-fit font-poppins text-white' >
      <div className='flex flex-col text-center' id="products">
        ...
        <p className='flex-lg font-normal max-w-[657px] text-center m-auto leading-[2rem]' >Stay Ahead of the Competition with Our State-of-the-Art Commerce Solutions. Empower Your Brand with Our End-to-End Commerce Products.</p>
      </div>
